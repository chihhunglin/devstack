...
2. Before running the provision command, make sure to pull the relevant
   docker images from dockerhub by running following commands.
...
6. For running acceptance tests on docker analyticstack, follow the instructions in the
   `Running analytics acceptance test in docker`_ guide.
...
.. _Running analytics acceptance test in docker: https://github.com/edx/edx-analytics-pipeline/tree/master/docs/source/running_acceptance_tests_in_docker.rst
.. _Troubleshooting docker analyticstack: https://github.com/edx/edx-analytics-pipeline/tree/master/docs/source/troubleshooting_docker_analyticstack.rst
